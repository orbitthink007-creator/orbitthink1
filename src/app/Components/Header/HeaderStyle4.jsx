            ...
            <div className="cs_main_header_in">
              ...
              <div className="cs_main_header_left">
                <Link className="cs_site_branding header-four" href="/">
                  <img src={data.site.logo} alt="Logo" />
                </Link>
              </div>
              ...
              <div className="cs_main_header_right">
                <div className="solutek-btn2">
                  <Link className="theme-btn5" href={data.header.ctaBtn.href}>{data.header.ctaBtn.label} <span><i className="bi bi-arrow-right"></i></span></Link>
                </div>
              </div>
            </div>
          </div>
