          ...
          <div className="row">
            <div className="col-lg-5">
              <div className="main-headding">
                <span className="span" data-aos="zoom-in-left" data-aos-duration="700"><img src="/assets/img/icons/orbitCircle.png" alt="" style={{ height: '18px', width: '18px', objectFit: 'contain' }} /> {subTitle}</span>
